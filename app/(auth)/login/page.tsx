    ...
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        <div className="w-16 h-16 bg-primary rounded-2xl mx-auto mb-4 flex items-center justify-center">
          <span className="text-2xl font-bold text-primary-foreground">ر</span>
        </div>
        <h1 className="text-2xl font-bold text-white">مجموعة عبد الفتاح راشد</h1>
        <p className="text-slate-400 text-sm mt-1">عبد الفتاح راشد سليمان</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <p className="text-center text-xs text-slate-500 mt-6">
          نظام إدارة مجموعة عبد الفتاح راشد — الكويت
        </p>
      </div>
    </div>
  );

...
export default async function SettingsPage() {
  ...
  const [companiesCount, usersCount, rolesCount, groups] = await Promise.all([
  ...
  return (
    <div>
      <Header
        ...
        subtitle="إدارة المجموعات والشركات"
        actions={
          <Link
              ...
              {group.companies.length === 0 ? (
                ...
                <div className="space-y-2">
                  {group.companies.map((company) => (
                    <div key={company.id} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg hover:bg-muted/50 transition-colors">
                      <div className="flex items-center gap-3">

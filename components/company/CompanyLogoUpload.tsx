...
export function CompanyLogoUpload({ companyId, currentLogoUrl, companyName, isSuperAdmin }: Props) {
  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="space-y-2">
        <p className="text-sm font-semibold">شعار الشركة</p>
        <p className="text-xs text-muted-foreground">JPG · PNG · WebP · SVG — حد أقصى 2 ميجابايت</p>
        <p className="text-xs text-muted-foreground">يظهر في صفحة الغلاف وعند الطباعة</p>
